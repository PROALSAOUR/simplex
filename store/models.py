...
class Product(models.Model):
    ...
    VISIBLE_CHOICES = [(False, 'مخفي'), (True, 'ظاهر'),]
    is_visible = models.BooleanField(default=True , choices=VISIBLE_CHOICES, verbose_name='حالة الظهور', help_text="قم بالأختيار ان كنت ترغب بإظهار المنتج للزبائن مباشرة \n ان لم تقم بتحديده سيتم إخفاء المنتج ولن يتمكن زبائنك من رؤيته")
    ...
    gender = models.CharField( verbose_name="الجنس المستهدف", max_length=20, choices=GENDER_CHOICES, default='unisex', help_text="حدد إن كان المنتج موجّه للرجال أو النساء أو مناسب لكلا الجنسين")
