...
class Product(models.Model):
    ...
    status = models.CharField(verbose_name='حالة المنتج', max_length=20, choices=[('checking', 'جاري المراجعة'), ('approved', 'مقبول'), ('rejected', 'مرفوض')], default='checking', help_text="جاري المراجعة: تم رفع المنتج وسيتم مراجعته من قبل الإدارة خلال 24 ساعة | مقبول: تم قبول المنتج وهو ظاهر للزبائن | مرفوض: تم رفض المنتج لعدم مطابقته لمعايير الجودة أو لأي سبب آخر،")
